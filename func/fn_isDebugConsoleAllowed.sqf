...
private _localID = [] call (missionNamespace getVariable "tac1_admin_local_uid");
if ((_localID in ([] call (missionNamespace getVariable "tac1_adminIDs"))) or (serverCommandAvailable "#kick")) exitWith { true };
